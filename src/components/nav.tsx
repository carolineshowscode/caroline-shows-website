  ...
  return (
    <nav className='border-0 bg-primary sm:text-xl'>
      <ul className='flex p-4 sm:p-8'>
        ...
        <li className='bg-mediumBlue p-2 skew-x-12 shadow-2xl shadow-mediumBlue border-y hover:scale-110'>
          <Link href="/about">About</Link>
        </li>
        <li className='bg-lightBlue p-2 skew-x-12 shadow-2xl shadow-lightBlue border hover:scale-110'>
